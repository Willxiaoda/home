$(document).ready(function(){
	...
	var culAddress = new Array("http://www.xingkong.us/home/about","http://www.xingkong.us/show","http://gf.xingkong.us/")
	// 先定义组织文化中图片的张数
	//先默认3张
	var culturePic = 3;
	//定义存放文字的数组
	...
	for(var i = 0;i<culturePic;i++){
		culContent.append('<a><div class="cultureImg"><div class="cultextup"><img src="image/caselogo.png" /></div><div class="cultextdown"><p></p></div></div></a>');
